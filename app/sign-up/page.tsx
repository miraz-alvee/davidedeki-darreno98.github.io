          ...
          px-6 py-10 sm:px-10 sm:py-12 md:px-14 md:py-14"
            ...
            >
                ...
                <p className="font-poppins text-center font-normal text-[13px] sm:text-[24px] md:text-[15px] text-[#444444] mb-7 sm:mb-8">
                    Please share your details to take the next step forward
                </p>
                ...
                <div className="mb-4">
                    <div className="flex items-center border border-[#CCCCCC] rounded-full px-4 sm:px-5 py-3 sm:py-3.5 bg-white focus-within:border-[#5B5BD6] transition-colors">
                        <span className="text-[13px] sm:text-[16px] font-medium text-[#444444] whitespace-nowrap mr-3 pr-5 border-r border-[#CCCCCC]">
                            Business
                        </span>
                        <input
                            type="text"
                ...
                <button
                    type="button"
                    className="w-full bg-[#5B5BD6] hover:bg-[#4a4ac4] active:bg-[#3d3db8] text-white font-bold text-[15px] sm:text-[16px] rounded-full py-2.5 sm:py-3.5 transition-colors duration-200 shadow-sm mt-5"
                >
                    Create Account
                </button>
                ...
                <p className="font-poppins font-normal text-center text-[13px] sm:text-[18px] text-[#020202] mt-5 sm:mt-6">
                    ...
                    <Link href="/login" className="font-poppins font-medium text-center text-[13px] sm:text-[18px] text-[#020202] underline underline-offset-2 hover:text-[#5B5BD6] transition-colors">Log in</Link>
                </p>
            </form>
        </div>
    )
